...
## [1.3.7] - 2022-06-16
### Changed
- .github/workflows/go.yml; ci: remove matricies, ci: run all releases same time

## [1.3.6] - 2022-06-16
### Changed
- .github/workflows/go.yml; ci: publish arm

## [1.3.5] - 2022-06-16
### Changed
- .github/actions/build-changehelper/action.yml; ci: fix arm build (#10)
- .github/workflows/go.yml; ci: fix arm build (#10)

## [1.3.4] - 2022-06-16
### Changed
- .github/workflows/go.yml; ci: build linux arm on darwin

## [1.3.3] - 2022-04-13
### Fixed
- options.go; fix: assume options is always a pointer

## [1.3.2] - 2022-03-31
### Changed
- .github/workflows/go.yml; ci: checkout for release

## [1.3.1] - 2022-03-31
### Changed
- .github/workflows/go.yml; ci: use full tag path
...
- git.go; docs: fix comment schemes
- models.go; docs: fix comment schemes
- go.mod; docs: fix comment schemes
- .github/actions/build-changehelper/action.yml; docs: fix comment schemes
- changelog.go; docs: fix comment schemes
- cmd.go; docs: fix comment schemes
- conventional_commits.go; docs: fix comment schemes
- .gitignore; docs: fix comment schemes
- go.sum; docs: fix comment schemes
- main.go; docs: fix comment schemes
- LICENSE; docs: fix comment schemes
- utils.go; docs: fix comment schemes
- logger.go; docs: fix comment schemes
- README.md; docs: fix comment schemes
- version.go; docs: fix comment schemes
- options.go; docs: fix comment schemes
- semver.go; docs: fix comment schemes
- .github/workflows/go.yml; docs: fix comment schemes
